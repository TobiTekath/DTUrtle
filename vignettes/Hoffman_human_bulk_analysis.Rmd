...
This visualization shows the structure of the transcripts of *TSC22D3*. Our significant transcripts (*TSC22D3-206*) is quite different to the other mainly expressed transcript (*TSC22D3-203*). *TSC22D3-206* has a different frist exon than *TSC22D3-203*, whichs first exon is quite far away from the conserved transcript body. The arrows on the right side indicate the mean fitted proportional change in the comparison groups, thus showing a over-expression of *TSC22D3-206* in `Dex2hr` compared to `EtOH`.
