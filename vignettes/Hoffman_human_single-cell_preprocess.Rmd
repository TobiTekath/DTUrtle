...
Another drawback of the concatenation of the files for the upload is, that the read names do not match between the samples. We also can overcome this with the following *bash* commands:
